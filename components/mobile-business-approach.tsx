import { Zap, Layout, Users, ShieldCheck, TrendingUp, ArrowUpRight, Layers } from "lucide-react";
...
const businessValues = [
    ...
    },
    {
        ...
        description: "Building uniform experiences across iOS and Android with a single shared codebase.",
        icon: Layers,
        color: "text-cyan-600",
        bg: "bg-cyan-50",
