...
import {
    SiApple, SiAndroid, SiFlutter, SiReact,
    SiSwift, SiKotlin,
    SiFirebase, SiSupabase, SiGraphql,
    SiXcode, SiAndroidstudio
} from "react-icons/si";

const techCategories = [
    {
        title: "Cross-Platform",
        description: "One codebase, two platforms.",
        techs: [
    ...
    },
    {
        ...
        description: "Maximum performance and OS integration.",
        techs: [
        ...
        <section className="py-20 bg-slate-50 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    >
                        We use the latest frameworks to build secure, scalable, and high-performance mobile apps.
                    </motion.p>
                </div>
