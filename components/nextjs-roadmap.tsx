...
import { Search, PenTool, Layout, Rocket, Settings } from "lucide-react";

const roadmapSteps = [
    {
        id: 1,
        title: "Strategy & Architecture",
        description: "We analyze your requirements and plan a scalable Next.js architecture, selecting the right rendering strategies (SSR, SSG, ISR) for your needs.",
        icon: Search,
    },
    {
        id: 2,
        title: "UI/UX & Wireframing",
        description: "Designing pixel-perfect interfaces that align with your brand, focusing on component reusability and accessibility from day one.",
        icon: PenTool,
    },
    {
        id: 3,
        title: "Next.js Development",
        description: "Building the application using the App Router, React Server Components, and Tailwind CSS for maximum performance and maintainability.",
        icon: Layout,
    },
    {
        id: 4,
        title: "API Integration & Testing",
        description: "Seamlessly integrating with headless CMS, databases, and third-party APIs while ensuring robust end-to-end testing.",
        icon: Rocket,
    },
    {
        id: 5,
        title: "Optimization & Deployment",
        description: "Fine-tuning Core Web Vitals, configuring edge caching, and deploying to Vercel/AWS for a global, lightning-fast launch.",
        icon: Settings,
    }
];
