...
const faqs = [
    {
        question: "Do you offer custom Next.js web development services?",
        answer: "Yes, we build fully customized Next.js applications tailored to business goals, performance needs, and scalability requirements."
    },
    {
        question: "Can you migrate my existing website to Next.js?",
        answer: "Yes, we provide seamless migration from WordPress, PHP, React, and legacy systems to Next.js without SEO loss."
    },
    {
        question: "Is Next.js suitable for SaaS platforms?",
        answer: "Absolutely. Next.js is ideal for SaaS dashboards, admin panels, and customer portals due to its performance and scalability."
    },
    {
        question: "How do you ensure SEO optimization in Next.js projects?",
        answer: "We implement SSR/SSG, structured data, canonical tags, optimized metadata, and automated sitemaps."
    },
    {
        question: "Do you provide ongoing support after deployment?",
        answer: "Yes, we offer maintenance, performance optimization, security updates, and feature enhancements."
    },
    {
        question: "What industries do you serve with Next.js solutions?",
        answer: "We work with SaaS, FinTech, EdTech, HealthTech, E-commerce, and Enterprise companies."
    }
];
...
export default function NextJsFAQ() {
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-4xl lg:text-5xl font-extrabold text-[#3A0F67] mb-6">
                        Next.js Development <span className="text-[#6366f1]">Questions</span>
                    </h2>
