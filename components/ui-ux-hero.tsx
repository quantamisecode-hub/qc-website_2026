            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center">
                ...
                >
                    ...
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#3A0F67] mb-6 tracking-tight leading-[1.15]">
                        Scalable <span className="text-[#6366f1]">UI/UX </span><br className="hidden sm:block" />
                        Design
                    </h1>

                    <p className="text-lg text-slate-600 max-w-3xl mx-auto mb-10 leading-relaxed font-medium">
                        We build robust, scalable, and high-performance web applications using cutting-edge technologies. From intuitive frontends to powerful backends, we deliver complete digital solutions.
                    </p>
