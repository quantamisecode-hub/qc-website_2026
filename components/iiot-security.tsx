import { Lock, ShieldCheck, Zap, Server, Cloud, Network } from "lucide-react";
...
const securityFeatures = [
    ...
    },
    {
        ...
        description: "Isolated network zones to contain potential breaches and protect critical systems.",
        icon: Network,
