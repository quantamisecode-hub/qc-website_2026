...
const faqs = [
    {
        question: "Do you build custom e-commerce platforms?",
        answer: "Yes, we develop fully customized and headless e-commerce platforms tailored to your business model and growth goals."
    },
    {
        question: "Can you migrate existing stores to new platforms?",
        answer: "Yes, we handle secure migrations from legacy systems to modern platforms with zero data loss and minimal downtime."
    },
    {
        question: "How do you improve e-commerce conversion rates?",
        answer: "We use data analytics, AI personalization, CRO testing, and user behavior tracking to increase sales and retention."
    },
    {
        question: "Do you integrate third-party tools and marketplaces?",
        answer: "Yes, we integrate payment gateways, shipping providers, ERP systems, CRM tools, and multi-channel marketplaces."
    },
    {
        question: "Do you provide post-launch maintenance?",
        answer: "Yes, we offer continuous monitoring, security updates, performance optimization, and feature enhancements."
    },
    {
        question: "How long does it take to build a custom e-commerce store?",
        answer: "The timeline varies based on complexity, typically ranging from 4-8 weeks for standard stores to 3-6 months for enterprise platforms."
    }
];
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                        Answers to your questions about launching an online store.
                    </p>
                </div>
