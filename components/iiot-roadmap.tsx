...
import { Cpu, Wifi, Cloud, BarChart, ShieldAlert } from "lucide-react";

const roadmapSteps = [
    {
        id: 1,
        title: "Hardware Selection & Prototyping",
        description: "Evaluating sensors, gateways, and microcontrollers to build a proof-of-concept for data acquisition.",
        icon: Cpu,
    },
    {
        id: 2,
        title: "Firmware Development",
        description: "Writing efficient, low-latency firmware code (C/C++, Python) for edge devices to process data locally.",
        icon: Wifi,
    },
    {
        id: 3,
        title: "Cloud Integration",
        description: "Connecting devices to AWS/Azure IoT Core securely via MQTT/CoAP for data ingestion and device management.",
        icon: Cloud,
    },
    {
        id: 4,
        title: "Analytics & Dashboarding",
        description: "Visualizing real-time streams with Grafana/Tableau and setting up alerts for anomaly detection.",
        icon: BarChart,
    },
    {
        id: 5,
        title: "Predictive Maintenance",
        description: "Implementing Machine Learning models on historical data to predict equipment failures before they happen.",
        icon: ShieldAlert,
    }
];
