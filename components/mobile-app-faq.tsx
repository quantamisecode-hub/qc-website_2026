...
const faqs = [
    {
        ...
        answer: "It depends. Native (Swift/Kotlin) offers best performance for complex apps. Cross-Platform (Flutter/React Native) saves time and cost by sharing code between iOS and Android. We help you choose the best fit."
    },
    {
        question: "How long does it take to build an app?",
        answer: "A simple MVP can take 2-3 months. More complex apps with custom backends and third-party integrations can take 4-6 months or longer. We provide a detailed timeline during discovery."
    },
    {
        question: "Do you handle App Store submission?",
        answer: "Yes, we handle the entire submission process, including metadata, screenshots, and compliance with Apple and Google guidelines to ensure your app gets approved."
    },
    {
        question: "Will I own the source code?",
        answer: "Yes, once the project is paid for, you have full ownership of the source code and all intellectual property rights."
    },
    {
        question: "Do you provide post-launch support?",
        answer: "Absolutely. We offer maintenance packages to keep your app updated with the latest OS versions, fix bugs, and add new features as your user base grows."
    },
    {
        question: "Can you integrate payment gateways?",
        answer: "Yes, we integrate secure payment gateways like Stripe, Apple Pay, Google Pay, and PayPal for seamless in-app purchases and subscriptions."
    }
];
        ...
        <section className="py-24 bg-slate-50 relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-4xl lg:text-5xl font-extrabold text-[#3A0F67] mb-6">Mobile <span className="text-[#6366f1]">Questions</span></h2>
                </div>
