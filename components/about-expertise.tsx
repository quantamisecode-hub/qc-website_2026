...
const expertiseItems = [
    ...
    { icon: Code2, title: "Next.js & Web Application Development" },
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {expertiseItems.map((item, index) => (
                        <motion.div
                            ...
                            className="group p-6 bg-white rounded-xl border border-gray-100 hover:shadow-lg hover:border-[#6366f1]/30 transition-all flex items-center gap-4 cursor-default"
                        >
