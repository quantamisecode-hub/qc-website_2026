...
import {
    ...
    SiGraphql, SiCplusplus, SiRust, SiMqtt, SiApachekafka, SiTensorflow, SiElasticsearch, SiApachespark, SiD3Dotjs, SiGo
} from "react-icons/si";
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                <div className="text-left mb-20">
                    ...
                    <p className="text-lg text-slate-600 max-w-2xl">
                        We work with the best tools and frameworks to ensure flexibility and future extensibility.
                    </p>
                </div>
                ...
                <div className="flex flex-col gap-12 lg:gap-16">
                    {[
                        {
                            title: "Edge & Device Layer",
                            description: "Low-level programming & Communication Protocols",
                            techs: [
                        ...
                        {
                            title: "Backend & Cloud",
                            description: "Scalable Server-side & Cloud Infrastructure",
                            techs: [
                                { name: "Node.js", icon: SiNodedotjs, color: "#339933" },
                        ...
                        },
                        {
                            ...
                            description: "Big Data Processing & Machine Learning",
                            techs: [
                        ...
                        },
                        {
                            ...
                            description: "Real-time Visualization & User Interface",
                            techs: [
