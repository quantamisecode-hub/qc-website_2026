...
import {
    SiApple, SiAndroid, SiFlutter, SiReact, SiSwift,
    SiKotlin, SiFirebase, SiSupabase
} from "react-icons/si";
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center">
                ...
                >
                    ...
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#3A0F67] mb-6 tracking-tight leading-[1.15]">
                        High-Performance <span className="text-[#6366f1]">Mobile</span><br className="hidden sm:block" />
                        Applications
                    </h1>

                    <p className="text-lg text-slate-600 max-w-3xl mx-auto mb-10 leading-relaxed font-medium">
                        We build stunning, responsive, and robust mobile applications for iOS and Android. From idea to App Store launch, we handle it all.
                    </p>
...
const tools = [
    { name: "iOS", icon: SiApple, color: "#000000", initialX: 0, initialY: 0, left: "10%", top: "15%" },
    { name: "Android", icon: SiAndroid, color: "#3DDC84", initialX: 0, initialY: 0, right: "15%", top: "12%" },
    { name: "Flutter", icon: SiFlutter, color: "#02569B", initialX: 0, initialY: 0, left: "5%", top: "45%" },
    { name: "React Native", icon: SiReact, color: "#61DAFB", initialX: 0, initialY: 0, right: "8%", top: "40%" },
    { name: "Swift", icon: SiSwift, color: "#F05138", initialX: 0, initialY: 0, left: "15%", bottom: "20%" },
    { name: "Kotlin", icon: SiKotlin, color: "#7F52FF", initialX: 0, initialY: 0, right: "20%", bottom: "25%" },
    { name: "Firebase", icon: SiFirebase, color: "#FFCA28", initialX: 0, initialY: 0, left: "25%", top: "10%" },
    { name: "Supabase", icon: SiSupabase, color: "#3ECF8E", initialX: 0, initialY: 0, right: "28%", top: "18%" },
];
