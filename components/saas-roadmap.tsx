...
import { Lightbulb, Layout, Rocket, TrendingUp, ShieldCheck } from "lucide-react";

const roadmapSteps = [
    {
        id: 1,
        title: "Idea Validation",
        description: "We validate your SaaS concept through market research, user personas, and feasibility analysis.",
        icon: Lightbulb,
    },
    {
        id: 2,
        title: "MVP Development",
        description: "Building the core functional version of your product to launch quickly and gather user feedback.",
        icon: Layout,
    },
    {
        id: 3,
        title: "Beta Launch",
        description: "Releasing to a closed group of early adopters to test performance, usability, and features.",
        icon: Rocket,
    },
    {
        id: 4,
        title: "Scaling & Optimization",
        description: "Optimizing infrastructure, database queries, and load balancing to support growing user traffic.",
        icon: TrendingUp,
    },
    {
        id: 5,
        title: "Enterprise Features",
        description: "Adding SSO, audit logs, role-based access control, and advanced reporting for large enterprise clients.",
        icon: ShieldCheck,
    }
];
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="text-center mb-20">
                    ...
                    <h2 className="text-4xl lg:text-5xl font-extrabold text-[#3A0F67] mb-6">
                        From Concept to <span className="text-[#6366f1]">Exit</span>
                    </h2>
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                        A structured path to building a successful subscription business.
                    </p>
                </div>
