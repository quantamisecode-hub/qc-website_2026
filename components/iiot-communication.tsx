import { UserCheck, MessageSquare, Calendar, RefreshCcw, LifeBuoy, Wrench } from "lucide-react";

const communicationFeatures = [
    {
        id: 1,
        title: "Dedicated Project Manager",
        description: "Your single point of contact who understands your goals and keeps the project on track.",
        icon: UserCheck,
    ...
    },
    {
        ...
        description: "Weekly sprints and transparent reporting so you always know exactly where we stand.",
        icon: MessageSquare,
    ...
    },
    {
        ...
        description: "Flexible, iterative development that adapts to feedback and changing market needs.",
        icon: RefreshCcw,
        color: "text-blue-600",
        bg: "bg-blue-50",
    },
    {
        ...
        description: "Ongoing monitoring and updates to keep your application running smoothly after launch.",
        icon: LifeBuoy,
        color: "text-cyan-600",
        bg: "bg-cyan-50",
    },
    {
        id: 6,
        title: "On-Site Calibration Support",
        description: "Assistance with physical device setup and sensor calibration for optimal accuracy.",
        icon: Wrench,
        color: "text-rose-600",
        bg: "bg-rose-50",
    }
...
export default function IiotCommunication() {
    return (
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="text-center mb-20">
                    ...
                    <h2 className="text-4xl lg:text-5xl font-extrabold text-[#3A0F67] mb-6">
                        Transparent Communication <span className="text-[#6366f1]">& Dedicated Support</span>
                    </h2>
