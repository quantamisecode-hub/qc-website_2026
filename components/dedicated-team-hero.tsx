            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center">
                ...
                >
                    ...
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#3A0F67] mb-6 tracking-tight leading-[1.15]">
                        Dedicated Development Teams for <span className="text-[#6366f1]">Scalable, High-Performance </span><br className="hidden sm:block" />
                        Digital Products
                    </h1>

                    <p className="text-lg text-slate-600 max-w-3xl mx-auto mb-10 leading-relaxed font-medium">
                        Build your extended engineering team with pre-vetted, full-time developers, architects, and AI specialists. Quantamise Code provides dedicated development teams that work exclusively on your projects—ensuring speed, quality, and complete transparency.
                    </p>
