...
const faqs = [
    {
        question: "How quickly will you respond to inquiries?",
        answer: "We typically respond within 24 business hours."
    },
    {
        question: "Do you offer free consultations?",
        answer: "Yes, we provide an initial project consultation at no cost."
    },
    {
        question: "Can you sign an NDA before discussion?",
        answer: "Absolutely. We are happy to sign NDAs to protect your ideas."
    },
    {
        question: "Do you work with international clients?",
        answer: "Yes, we serve clients globally with flexible engagement models."
    },
    {
        ...
        <section className="py-20 lg:py-28 bg-white relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-3xl md:text-4xl font-extrabold text-[#3A0F67] mt-2 mb-6">
                        Frequently Asked <span className="text-[#6366f1]">Questions</span>
                    </h2>
                    <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                        Quick answers to common questions about contacting and working with us.
                    </p>
                </div>
