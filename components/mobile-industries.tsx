            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-3xl lg:text-4xl font-extrabold text-[#3A0F67] mb-6">
                        Mobile Solutions Across <span className="text-[#6366f1]">Industries</span>
                    </h2>
                    <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                        We deliver tailored mobile applications for diverse sectors, driving digital transformation and growth.
                    </p>
                </div>
